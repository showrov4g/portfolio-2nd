  ...
  return (
    <div id="about" className="w-11/12 mx-auto my-32">
      <div className="flex flex-col">
        ...
        <hr className="w-80 h-1.5 bg-amber-400 border-none outline-none bg-linear-to-r from-[#1BAAF2] to-[#7566D2]" />
      </div>
      <div className="my-8">
        <p className="text-xl w-[80%] my-1">
      ...
      <div>
        <div className="my-5">
          ...
          <hr className="w-50 h-1.5 bg-amber-400 border-none outline-none bg-linear-to-r from-[#1BAAF2] to-[#7566D2]" />
        </div>
        <h5 className="text-2xl">Bachelor in Accounting</h5>
        <p>
